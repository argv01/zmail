...
#define HPUX 1		/* Needed for X11 header files */
...
#define _POSIX_SOURCE 1		/* needed for ISC, OSF/1, HP/UX */
#define _XOPEN_SOURCE 1		/* needed for OSF/1, HP/UX */
#define _HPUX_SOURCE 1		/* needed for HPUX */
...
#undef HAVE_STDLIB_H	/* Conflicts with INTERNAL_MALLOC */
#undef HAVE_MALLOC_H	/* Conflicts with INTERNAL_MALLOC */

#define SPOOR_ACSC "memu"
#define SPOOR_ENACS "kf0"
