...
#define _POSIX_SOURCE 1	/* needed for ISC */
#define _XOPEN_SOURCE 1	/* needed for ??? */
#define _HPUX_SOURCE 1	/* needed for HPUX */

#define MSG_SEPARATOR "\001\001\001\001\n"

/* corrections to autoconf output follow */
#undef HAVE_SIGPROCMASK		/* It doesn't work right on this platform */
#undef SAFE_REALLOC
#define LOCK_FCNTL 
#define ML_KERNEL 
#define BLOCK_AGAIN 
