...
LOCAL_LIBS = 
CURSES_LIB = -L/projects/zmail/lib/hp700_10/lib -lncurses
TERM_LIB = -ltermlib
DASH_L = -L 
EXTRA_INCLUDES = 
TEST_LINK = -h
...
CPP = 	cc -Wp,-H,256000 -I/usr/include/Motif1.2 -I/usr/include/X11R5 -I/projects/zmail/lib/hp700_10/include -E
COMPILER = cc
CXX = CC
LINKER = $(COMPILER)
...
COMPILER =	cc -Wp,-H,256000 -I/usr/include/Motif1.2 -I/usr/include/X11R5 -I/projects/zmail/lib/hp700_10/include
#OPTIMIZE =	-g
SHELL = /bin/sh
...
STATIC_LDFLAGS =	-Wl,-a,archive
SHARED_LDFLAGS =	-Wl,-a,shared
LDFLAGS = -L/usr/lib/Motif1.2 -L/usr/lib/X11R5 -L/projects/zmail/lib/hp700_10/lib
