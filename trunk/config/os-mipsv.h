/* os-mipsv.h	Copyright 1991 Z-Code Software Corp. */

/*
 * This file assumes the MIPS System V environment.  It is preferable to
 * compile in the bsd43 environment; MIPS' sysv file locking can deadlock.
 */
