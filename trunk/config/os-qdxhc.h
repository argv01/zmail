/* os-qdxhc.h	Copyright 1991 Z-Code Software Corp. */

/* os-dos.h	Copyright 1991 Z-Code Software Corp. */
...
#undef  HAVE_VARARGS	/* Has <varargs.h> and we should use it */
...
#undef  HAVE_RANDOM	/* Has random() and no srand() */
...
#ifndef DVX
#define DVX		/* DESQview/X environment */
#endif /* DVX */

#undef  u_long
#define u_long unsigned long

/* Rules for using UUPC/Extended under DOS */
#ifdef UUPC
#undef  MSG_SEPARATOR
#define MSG_SEPARATOR	"\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001\001\n"
#define MAIL_DELIVERY	"/usr/lib/sendmail"
#define VERBOSE_ARG	"-v"    /* undef if none exists */
#endif /* UUPC */

#ifndef MSDOS
#define MSDOS		/* Special handling of certain operations */
#endif /* !MSDOS */
