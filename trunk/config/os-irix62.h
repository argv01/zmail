...
#define HAVE_SSDEFAULTSCHEME_H 1
...
#define FAM_OPEN FAMOpen2		/* which FAMOpen() to use, if any */
#define HAVE_HELP_BROKER 1	/* Insight-based help system */
#define OZ_DATABASE "/usr/lib/filetype/desktop.otr"	/* drag & drop icons */
#define HAVE_IMPRESSARIO 1	/* Impressario print widget */
...
#define IRIX53			/* Yes, define IRIX53 even for IRIX 6.x */
#undef _NO_PROTO		/* the prototypes actually work here */
