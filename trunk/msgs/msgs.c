...
#ifndef lint
static char	msgs_rcsid[] = "$Id: msgs.c,v 2.126 2005/05/31 07:36:42 syd Exp $";
#endif
...
char *name;
{
    ...
    if (utimes(mailfile, (const struct timeval *) times) && errno != EPERM)
	error(SysErrWarning, "utime");
#endif /* HAVE_UTIMBUF */
}
...
#if !defined(HAVE_FTRUNCATE) && !defined(F_FREESP) && !defined(HAVE_CHSIZE)
    FILE 		*save_mail_fp = NULL_FILE;
#endif /* !HAVE_FTRUNCATE && !F_FREESP && !HAVE_CHSIZE */
#ifdef MAC_OS
