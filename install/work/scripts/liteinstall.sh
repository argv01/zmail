...
*)
    ...
    SOFTWARE='OpenZMail Classic Lite'
    export SOFTWARE
...
#    if test "$ans" != "y"
#    then
#	if test "$NETWORK_LICENSE" != true -a "$NETMANAGE_LICENSE" != true
#	then
#	    cat <<EOM
#
#-------------------------
#
#$SOFTWARE requires access to the directory $LICENSE_DIR
#to validate user licenses.  You may not change this location.
#Installation of $SOFTWARE will create this directory if it does
