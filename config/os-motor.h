...
#define MOTOROLA 1		/* Needed for X11 header files */
...
#define XT_ADD_INPUT_BROKEN
/*
 * From schaefer@z-code.com Fri Aug 12 18:45:33 1994
 * Date: Fri, 12 Aug 94 18:41:52 -0700
 * To: lowery@z-code.z-code.com
 * Cc: Spencer Sun <spencer@zyrcon.z-code.com>, schwa@zyrcon.z-code.com
 * Subject: Re: zmmotif-build/3335: Motorola 88000 SVR3 (M88K, Delta/88) build
 * 
 * 
 * 	`Barton E. Schaefer' changed the state to `analyzed'.
 * 
 * 
 * State-Changed-From-To: feedback-analyzed
 * State-Changed-By: schaefer
 * State-Changed-When: Fri Aug 12 18:40:08 1994
 * State-Changed-Why:
 * Crashes immmediately upon startup, in the Xt library.  Requires a rebuild
 * NOT using INTERNAL_MALLOC.  (Same problem appeared when building 3.0 with
 * INTERNAL_MALLOC on the m88k4 platform.)
 */
/* #define INTERNAL_MALLOC */
/* #undef HAVE_MALLOC_H	*/ /* Conflicts with INTERNAL_MALLOC */
/* #undef HAVE_STDLIB_H	*/ /* All it does is #include <malloc.h> */
#define NO_SET_LANGUAGE_PROC
