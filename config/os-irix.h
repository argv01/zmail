...
#define XT_R4_INCLUDES -I/projects/zmail/sources/X11R4/mit/lib/Xt	    /* Xt R4 internal headers available */
/* #undef HAVE_XT_BASE_TRANSLATIONS */	/* XmNbaseTranslations resources */
#define XEDITRES_HANDLER _EditResCheckMessages		/* name of editres event handler */
