/* os-sgib.h	Copyright 1991 Z-Code Software Corp. */

/*
 * This file assumes the IRIX -lbsd compatibility library.  It is preferable
 * to compile using the System V environment as far as we know.
 */
...
#define _BSD_COMPAT	/* IRIX Magic for BSD-izing header files */
#define _BSD_SIGNALS	/* IRIX Magic for BSD signal handling */
