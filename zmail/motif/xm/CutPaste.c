/*
 * Motif CutPaste.c, with an array-bounds-read problem fixed
 * if you want to use this you have to make CutPaste.o and link it
 * in before -lXm on the link command line
 * -- spencer, Wed Feb 15 14:34:02 PST 1995
 */
...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: CutPaste.c,v $ $Revision: 2.1 $ $Date: 1995/02/15 22:34:49 $"
#endif
#endif
/*
