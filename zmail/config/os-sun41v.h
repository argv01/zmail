...
#define HAVE_CHAR_FREE 1
#define SYSV_CURSES_BUG 1
#undef BSD
#define SYSV 1
#define XT_R4_INCLUDES -I/zyrcon/usr1/src/X11R4/mit/lib/Xt
#undef HAVE_XT_BASE_TRANSLATIONS
#undef XEDITRES_HANDLER
...
#define SYSV_CURSES_BUG 1	/* Has SysV curses bug */
#define NO_ENDWIN_FOR_SHELL_MODE 1
