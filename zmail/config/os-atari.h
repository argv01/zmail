/* os-atari.h	Copyright 1991 Z-Code Software Corp. */

/* Atari SystemVr4 is a Motorola 68k platform -- compile as MOTOROLA.
 *
 * Requires:
 *	-lcurses -ltermcap
 *	-L/usr/ucblib
 *	-lgen -lresolv -lsocket -lnsl
 *
 * Optionally:		[Doesn't work unless .cf has been fixed]
 *	-DMAIL_DELIVERY="/usr/ucblib/sendmail -i"
 */

/* os-motor.h	Copyright 1991 Z-Code Software Corp. */
...
#define SYSV_CURSES_BUG	2 /* Has SysV curses bug with drawing top few lines */
#define MOTOROLA	/* Needed for X11 header files */

#define SVR4		/* Get additional header files for SystemVr4 */
