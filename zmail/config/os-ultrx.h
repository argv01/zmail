...
/* it does have locale.h, it does have utimbuf, it does not have int sprintf */
/* -- spencer 8/25/95 */

#define ENV_NAME_BREAKS_SENDMAIL	/* Bug workaround */
#define NO_SET_LANGUAGE_PROC
#undef USE_XM_LIST_C			/* Until libXm.a v. list.c fixed */
