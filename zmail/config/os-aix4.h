...
#define NO_DECLARE_BCOPY
#undef USE_XM_LIST_C
#undef HAVE_STRINGS_H /* it tries to include string.h also, which causes problems */

#define SPOOR_ENACS "colb6"
#define SPOOR_ACSC "box2"
#define SYSV_SETPGRP
