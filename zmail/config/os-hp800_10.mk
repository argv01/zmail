...
CPP =  cc -Wp,-H,256000 -I/usr/include/Motif1.2 -I/usr/include/X11R5 -I/projects/zmail/lib/hp800_10/include -E
COMPILER = cc
CXX = CC
LINKER = $(COMPILER)
...
COMPILER = cc -Wp,-H,256000 -I/usr/include/Motif1.2 -I/usr/include/X11R5 -I/projects/zmail/lib/hp800_10/include

MISC_DEFS =	-D__TIMEVAL__ -DHAVE_NCURSES
...
# LDFLAGS = -L/usr/lib/Motif1.2 -L/usr/lib/X11R5 -Wl,-a,archive_shared 
LDFLAGS = -L/usr/lib/Motif1.2 -L/usr/lib/X11R5  -L/projects/zmail/lib/hp800_10/lib

# The following 3 macros are a starting point on avon if you'd like to build 
# zmail.static and zmail.shared 
#STATIC_LDFLAGS = -L/usr/lib/Motif1.2 -L/usr/lib/X11R5 -Wl,-a,archive_shared -ldld
#SHARED_LDFLAGS = -L/usr/lib/Motif1.2 -L/usr/lib/X11R5 
#CURSES_LIB = -lcurses -lcur_colr


CURSES_LIB = -L/projects/zmail/lib/hp800_10/lib -lncurses
