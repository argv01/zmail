...
# os-pyr4.mk     Copyright 1992 Z-Code Software Corp.
#
# This file supplies definitions specific to the Pyramid DC/OSx build
#

MOTIF_LIBS = -lXm -lXt -lX11
LOCAL_LIBS = -lresolv -lsocket -lnsl -lmail -lgen
