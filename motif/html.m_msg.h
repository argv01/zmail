/* This is a version of m_msg.h that uses the gnu HTML widget to display HTML */
...
typedef struct _msg_data {
    ...
    struct Msg this_msg;
    int    this_msg_no;
    Widget hdr_fmt_w, text_w, html_w;
...
#define MSG_NUM_TAG_IT_TEXT 4
    ...
    char       *html_string;
    char       *base_page;
#define MSG_MAX_HTML_STACK 10
    int        html_page_stack;
    char       *html_page_name[MSG_MAX_HTML_STACK];
    Boolean    html_page_local[MSG_MAX_HTML_STACK];
} msg_data;
